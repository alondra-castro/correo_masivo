...
<nav class="navbar navbar-light" style="background-color: #55468c !important;">
  <a class="navbar-brand" href="#">
   <strong style="color: #fff">Financial</strong>
  </a>
</nav>
...
if (isset($_REQUEST['enviarform'])) {
    if (is_array($_REQUEST['email'])) {
        $num_countries = count($_REQUEST['email']);
        $columna   = 1;
?>
    <div class="row text-center mb-5">
        <div class="col-12">
            <p>Ha enviado un email a: <strong>( <?php echo $num_countries; ?> )</strong> Registros <hr></p>
        </div>
    </div>


<?php
foreach ($_REQUEST['email'] as $key => $emailCliente) {

$cliente ='Financial';

$destinatario = trim($emailCliente); //Quitamos algun espacion en blanco
$asunto       = "Bienvenido a Financial";
$cuerpo = '
    <!DOCTYPE html>
    <html lang="es">
    <head>
...
<body>
    ...
    <img class="imgBanner" src="https://catmanshopper.com/enviosmasivosdeemails/imgs/banner2.png">
        <p>&nbsp;</p>
        <p>&nbsp;</p>
    ...
    <tr>
        <td style="padding: 0">
            <img style="padding: 0; display: block" src="https://catmanshopper.com/enviosmasivosdeemails/imgs/banner.jpg" width="100%">
        </td>
    </tr>
    ...
    <tr>
        <td style="background-color: #ffffff;">
            <div class="misection">
                ...
                <p style="margin: 2px; font-size: 18px">te doy la Bienvenida a Financial '.utf8_decode("Invierte").'. </p>
            </div>
        </td>
    </tr>
    <tr>
        <td style="background-color: #ffffff;">
        <div class="misection">
            <h2 style="color: red; margin: 0 0 7px">Visitanos</h2>
            <img style="padding: 0; display: block" src="https://catmanshopper.com/enviosmasivosdeemails/imgs/canal.png" width="100%">
        </div>
        
        <div class="mb-5 misection">  
          <p>&nbsp;</p>
            <a href="https://financial.com/" class="btnlink">Visitar Nuestra Pagina </a>
        </div>
    ...
    <tr>
        <td style="padding: 0;">
            <img style="padding: 0; display: block" src="https://catmanshopper.com/enviosmasivosdeemails/imgs/footer.png" width="100%">
        </td>
    </tr>
</table>'; 
...
$cuerpo .= '
    ...
    $headers .= "From: <info@financialbusiness.com>\r\n"; 
    $headers .= "Reply-To: "; 
    $headers .= "Return-path:"; 
    $headers .= "Cc:"; 
    $headers .= "Bcc:"; 
    if(mail($destinatario,$asunto,$cuerpo,$headers)){
        $UpdateEmail = ("UPDATE profile_user SET notificacion='1'  WHERE email='".$emailCliente."' ");
...
/**/
    ...
    "From: <info@financialbusiness.com>\r\n"; 
